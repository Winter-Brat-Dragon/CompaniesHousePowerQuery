// ---------------------------
// GetCompanyOfficers Function
// ---------------------------
// Input: API_URL_Officers (text)
// Output: List of officer records (empty list if no data or error)
(GetOfficersURL as text) as list =>
let
    // 1. Trim and validate input
    CleanURL = Text.Trim(GetOfficersURL),
